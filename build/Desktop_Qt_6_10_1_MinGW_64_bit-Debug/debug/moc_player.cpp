...
template <> constexpr inline auto Player::qt_create_metaobjectdata<qt_meta_tag_ZN6PlayerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'requestArrow'
        QtMocHelpers::SignalData<void(qreal)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QReal, 4 },
        }}),
        // Signal 'reachedDoor'
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->requestArrow((*reinterpret_cast<std::add_pointer_t<qreal>>(_a[1]))); break;
        case 2: _t->reachedDoor(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Player::*)()>(_a, &Player::dead, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)(qreal )>(_a, &Player::requestArrow, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Player::*)()>(_a, &Player::reachedDoor, 2))
            return;
    }
}
...
// SIGNAL 1
void Player::requestArrow(qreal _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Player::reachedDoor()
{
